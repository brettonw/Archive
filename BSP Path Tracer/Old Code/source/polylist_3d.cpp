...
//	add to list
//------------------------------------------------------------------------------
void		polylist::Copy (listptr &list)																					//	append the contents of list to this list in a non-destructive manner
{																																								//	begin
	node	*current = list->head;																									//	get the head of the list
	while (current)																																//	while the current element of the list is valid
	{																																							//	begin
		AddToList (current->ptr);																										//	add the contents to this list
