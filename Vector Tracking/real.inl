...
{
    return (AbsoluteValue<Number> (m_number - real.m_number) <= s_epsilon);
}
...
TReal<Number>::operator + (const Number& number) const
{
    return TReal<Number> (m_number + number);
}
...
TReal<Number>::operator + (const TReal<Number>& real) const
{
    return TReal<Number> (m_number + real.m_number);
}
...
TReal<Number>::operator - (const TReal<Number>& real) const
{
    return TReal<Number> (TReal<Number> (m_number - real.m_number));
}
