...
{																																								//	begin
	...
	if (FABS (xyz[Y]) > FABS (xyz[X]))																							//	if the y component of the tuple_3d is greater than x
		axis = Y;																																		//	y is the major axis
	if (FABS (xyz[Z]) > FABS (xyz[axis]))																						//	if the Z component of the tuple_3d is greater
