...
//-----------------------------------------------------------------------------
extern  std::hash_map<int, int> g_IntersectionCode;
...
struct EndPoint
{
    TChainList<Real>::iterator  chainIter;
    Real                        rOffsetA;
    Real                        rOffsetB;
    bool                        bFront;
    /* void */                  EndPoint (TChainList<Real>::iterator _chainIter, Real _rOffsetA, Real _rOffsetB, bool _bFront) :
...
{
    bool    operator () (const TChainList<Real>::iterator& lhs, const TChainList<Real>::iterator& rhs) const
    {
        return (*(int*)&lhs) < (*(int*)&rhs);
    }
};
template<class Real>
class IteratorSet : public std::set<TChainList<Real>::iterator, ChainListIteratorCompare<Real> > {};

//-----------------------------------------------------------------------------
// functions
//-----------------------------------------------------------------------------
template<class Real>
EndPointVec<Real>::iterator
JoinChains (TChainList<Real>& chainsOut, EndPointVec<Real>::iterator endPointIter)
{
